...
func Pkcs11Config608() *Config608 {
	var conf Config608
	err := UnmarshalPartial(PKCS11Config, PermanentOffset608, &conf)
	if err != nil {
		panic(err)
	}
	return &conf
...
func FirmwareConfig608() *Config608 {
	var conf Config608
	err := Unmarshal(FirmwareConfig, &conf)
	if err != nil {
		panic(err)
	}
	return &conf
